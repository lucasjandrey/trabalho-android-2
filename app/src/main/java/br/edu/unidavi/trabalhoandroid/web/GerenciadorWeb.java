...
public abstract class GerenciadorWeb extends AsyncTask<Void, Void, Void> {
    public static final int RESPONSE_OK = 200;
    public static final int RESPONSE_INVALID_REQUEST = 403;
    private static int TIMEOUT = 15;
    private static String BASE_URL = "http://private-02288-trabalhoandroid.apiary-mock.com/";
    ...
    public GerenciadorWeb(Context context, String serviceURL) {
